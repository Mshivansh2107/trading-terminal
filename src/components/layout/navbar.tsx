...
import { LayoutDashboard, TrendingUp, ShoppingBag, ShoppingCart, BarChart3, LogOut, ArrowLeftRight, Users, Banknote, DollarSign, Building, LayoutGrid, UserCheck, BookOpen } from 'lucide-react';
    ...
    <nav className="fixed top-0 left-0 h-full w-16 md:w-64 bg-gray-800 text-white">
      <div className="flex flex-col h-full">
        <div className="p-4 mb-6">
          <h1 className="text-xl font-bold hidden md:block">Blynk Virtual Technologies</h1>
        ...
        <div className="flex-1 px-3">
          ...
          >
            ...
            <span className="ml-3 hidden md:block">CRM</span>
          </NavLink>
          ...
          >
            ...
            <span className="ml-3 hidden md:block">Ledger</span>
          </NavLink>
