...
import { salesAtom, addSaleAtom, updateSaleAtom, deleteSaleAtom, banksAtom, platformsAtom, refreshDataAtom, beneficiariesAtom } from '../store/data';
...
const Sales = () => {
  ...
  const columns = useMemo(() => [
    ...
    { 
      key: 'name', 
      label: 'Name',
      formatter: (value: string, row: SalesEntry) => {
